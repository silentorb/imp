...
namespace imp_test.tests
{
    ...
    public class Runic_Test
    {
        ...
        public void test()
        {
            ...
            var runes = Summoner.read_runes(code, "imp.pizza.imp");
            Assert.Greater(runes.Count, 5);

            var legend = Summoner.translate_runes(code, runes);
        ...
        public void test_if()
        {
            ...
            var runes = Summoner.read_runes(code, "imp.if.imp");
            var legend = Summoner.translate_runes(code, runes, "if_statement");
        ...
        public void test_if_else()
        {
            ...
            var runes = Summoner.read_runes(code, "imp.if_else.imp");
            var legend = Summoner.translate_runes(code, runes, "statements");
        ...
        public void test_empty_array()
        {
            ...
            var runes = Summoner.read_runes(code, "imp.empty_array.imp");
            var legend = Summoner.translate_runes(code, runes, "statement");
        ...
        public void test_anonymous_function()
        {
            ...
            var runes = Summoner.read_runes(code, "imp.anonymous_function.imp");
            var legend = Summoner.translate_runes(code, runes, "statement");
